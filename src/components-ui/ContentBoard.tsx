  ...
  return (
    <div className=" grow h-screen flex flex-col bg-brown-300">
      ...
      <div className=" bg-orange-200 grow overflow-y-auto p-2 pb-10">
        ...
        <p>创1:3 神说：要有光，就有了光。</p>
        <p>创1:4 神看光是好的，就把光暗分开了。</p>
        <p>创1:5 神称光为昼，称暗为夜。有晚上，有早晨，这是头一日。</p>
        <p>创1:6 神说：诸水之间要有空气，将水分为上下。</p>
        <p>
          创1:7 神就造出空气，将空气以下的水、空气以上的水分开了。事就这样成了。
        </p>
        <p>创1:8 神称空气为天。有晚上，有早晨，是第二日。</p>
        <p>创1:9 神说：天下的水要聚在一处，使旱地露出来。事就这样成了。</p>
        <p>创1:10 神称旱地为地，称水的聚处为海。神看着是好的。</p>
        <p>
          创1:11
        ...
        <p>创1:13 有晚上，有早晨，是第三日。</p>
        <p>
          创1:14 神说：天上要有光体，可以分昼夜，作记号，定节令、日子、年岁，
        </p>
        <p>创1:15 并要发光在天空，普照在地上。事就这样成了。</p>
        <p>创1:16 于是神造了两个大光，大的管昼，小的管夜，又造众星，</p>
        <p>创1:17 就把这些光摆列在天空，普照在地上，</p>
        <p>创1:18 管理昼夜，分别明暗。神看着是好的。</p>
        <p>创1:19 有晚上，有早晨，是第四日。</p>
        <p>
          创1:20
        ...
        <p>创1:27 神就照着自己的形像造人，乃是照着他的形像造男造女。</p>
        <p>
          创1:28
        ...
        <p>创1:31 神看着一切所造的都甚好。有晚上，有早晨，是第六日。</p>
      </div>
    </div>
  )
}
